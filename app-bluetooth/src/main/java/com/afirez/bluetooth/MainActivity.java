...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.bt_tv_read).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initDevice() {
        ...
        if (targetDevice == null) {
            if (!findBoundTargetDevice()) {
                Log.i(TAG, "Not Found Bound Device: named start with " + FILTER);
                findTargetDevice();
            } else {
                onDeviceInitialized();
            }
...
//                }
    ...
    private void onRead(IDCardItem item) {
        long currentTimeMillis = System.currentTimeMillis();
        long totalTime = currentTimeMillis - startTime;
        long readTime = currentTimeMillis - readStartTime;
        Log.d(TAG, "onRead: totalTime = " + totalTime);
        Log.d(TAG, "onRead: readTime = " + readTime);
        Log.d(TAG, "onRead: " + item.toString());
    }
