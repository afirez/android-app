        ...
        if (mAppFragmentLifecycleCallbacks == null) {
            mAppFragmentLifecycleCallbacks = new FragmentManager.FragmentLifecycleCallbacks() {
                ...
                public void onFragmentPreAttached(FragmentManager fm, Fragment f, Context context) {
                    Timber.i("onFragmentPreAttached: %s", f);
                }

                @Override
                public void onFragmentAttached(FragmentManager fm, Fragment f, Context context) {
                    Timber.i("onFragmentAttached: %s", f);
                }

                @Override
                public void onFragmentPreCreated(FragmentManager fm, Fragment f, Bundle savedInstanceState) {
                    Timber.i("onFragmentPreCreated: %s", f);
                }

                @Override
                public void onFragmentCreated(FragmentManager fm, Fragment f, Bundle savedInstanceState) {
                    Timber.i("onFragmentCreated: %s", f);
                }

                @Override
                public void onFragmentActivityCreated(FragmentManager fm, Fragment f, Bundle savedInstanceState) {
                    Timber.i("onFragmentActivityCreated: %s %s", f, savedInstanceState);
                }

                @Override
                public void onFragmentViewCreated(FragmentManager fm, Fragment f, View v, Bundle savedInstanceState) {
                    Timber.i("onFragmentViewCreated: %s", f);
                }

                @Override
                public void onFragmentStarted(FragmentManager fm, Fragment f) {
                    Timber.i("onFragmentStarted: %s", f);
                }

                @Override
                public void onFragmentResumed(FragmentManager fm, Fragment f) {
                    Timber.i("onFragmentResumed: %s", f);
                }

                @Override
                public void onFragmentPaused(FragmentManager fm, Fragment f) {
                    Timber.i("onFragmentPaused: %s", f);
                }

                @Override
                public void onFragmentStopped(FragmentManager fm, Fragment f) {
                    Timber.i("onFragmentStopped: %s", f);
                }

                @Override
                public void onFragmentSaveInstanceState(FragmentManager fm, Fragment f, Bundle outState) {
                    Timber.i("onFragmentSaveInstanceState: %s %s", f, outState);
                }

                @Override
                public void onFragmentViewDestroyed(FragmentManager fm, Fragment f) {
                    Timber.i("onFragmentViewDestroyed: %s", f);
                }

                @Override
                public void onFragmentDestroyed(FragmentManager fm, Fragment f) {
                    Timber.i("onFragmentDestroyed: %s", f);
                }

                @Override
                public void onFragmentDetached(FragmentManager fm, Fragment f) {
                    Timber.i("onFragmentDetached: %s", f);
                }
            };
        }
